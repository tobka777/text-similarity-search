...
class SICK(BaseBenchmark):
  def load_dataset(self, lang='en'):
    if lang=='de':
      #train = self.load_dataset_from_file("data/sickbenchmark_de/sick_de-train.csv", 1, 2, 3, ",")
      #dev = self.load_dataset_from_file("data/sickbenchmark_de/sick_de-dev.csv", 1, 2, 3, ",")
